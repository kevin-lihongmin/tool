...
import com.kevin.tool.mutilthreadtransaction.transaction.ThreadTransactionInterceptor;
...
/**
 *	自定义{@link RepositoryProxyPostProcessor} 用于替换硬编码的{@link TransactionInterceptor} 类型Aop Advice
 *
 * @author lihongmin
 * @date 2019/12/18 16:42
 * @since 1.0.0
 */
class ThreadTransactionalRepositoryProxyPostProcessor implements RepositoryProxyPostProcessor {
	...
	/**
	 * Creates a new {@link ThreadTransactionalRepositoryProxyPostProcessor} using the given {@link ListableBeanFactory} and
	 ...
	 */
	public ThreadTransactionalRepositoryProxyPostProcessor(ListableBeanFactory beanFactory, String transactionManagerName,
	...
	/**
	 * Implementation of the {@link TransactionAttributeSource} interface for
	 ...
	 * annotation (if present). This class may also serve as base class for a
	...
	static class CustomAnnotationTransactionAttributeSource extends AbstractFallbackTransactionAttributeSource
		 ...
		 * {@code Transactional} annotation or the EJB3  annotation.
		 */
