...
/**
 *	{@link ThreadJpaRepositoriesRegistrar} 注入
 *
 * @author lihongmin
 * @date 2019/12/18 16:40
 * @since 1.0.0
 * @see ThreadTransactionalRepositoryProxyPostProcessor#postProcess(ProxyFactory, RepositoryInformation)
 * @see AbstractApplicationContext#refresh()
 * @see RepositoryBeanDefinitionRegistrarSupport#registerBeanDefinitions(AnnotationMetadata, BeanDefinitionRegistry)
 * @see JpaRepositoryFactory#getRepository(Class, RepositoryComposition.RepositoryFragments)
 */
@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Inherited
@Import(ThreadJpaRepositoriesRegistrar.class)
public @interface EnableThreadJpaRepositories {
