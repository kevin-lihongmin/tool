...
/**
 *  VSO转SO 检查服务 {@link com.kevin.tool.order.code.check.StateConfig#VSO_TO_SO}
 *
 ...
 * @since 1.0.0
 * @see com.kevin.tool.order.code.check.StateConfig#VSO_TO_SO
 */
@Service
public class Vso2SoService implements SegmentCodeImpl {
