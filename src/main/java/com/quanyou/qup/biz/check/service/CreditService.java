...
import com.quanyou.qup.biz.check.client.CreditRemoteService;
...
import com.quanyou.qup.biz.check.dto.response.CreditResultDTO;
import com.quanyou.qup.biz.check.manager.component.AbstractCheckService;
import com.quanyou.qup.biz.check.manager.component.ConfigServiceCache;
import com.quanyou.qup.biz.check.manager.component.CreditResultDTOFactory;
...
import static com.quanyou.qup.biz.check.constant.BusinessExceptionEnum.SEARCH_EXCEPTION;
import static com.quanyou.qup.biz.check.constant.BusinessExceptionEnum.buildException;
import static com.quanyou.qup.biz.check.constant.SelectByEnum.*;
import static com.quanyou.qup.biz.check.constant.ThreadPoolEnum.CREDIT_TYPE_ITEM;
...
public class CreditService extends AbstractCheckService {
    ...
    private CreditResultDTO creditTemplate(CheckRequestDTO checkRequestDTO) {
        ...
        ThreadPoolExecutor executor = THREAD_POOL_EXECUTOR_MAP.get(CREDIT_TYPE_ITEM.name());
        ...
        try {
            ...
            buildException(SEARCH_EXCEPTION);
        }
        return null;
    }
}