...
import com.biz.check.feign.dto.enums.CreditSelectByEnum;
import lombok.Data;
...
public class CreditResultDTO extends ResultDTO implements Serializable, Cloneable {
     ...
     * @see CreditSelectByEnum#CREDIT_VSO_FROZEN {@link #minusBalance} = {@link #balance} - {@link #vsoBalance} - {@link #costAmount}
     * @see CreditSelectByEnum#CREDIT_PO_VSO_FROZEN {@link #minusBalance} = {@link #balance} - {@link #poBalance} - {@link #vsoBalance} - {@link #costAmount}
     */
